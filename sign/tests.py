...
class IndexPageTest(TestCase):
    ...
    def test_index_page_renders_index(self):
        '''测试index视图'''
...
class LoginActionTest(TestCase):
    '''测试登录动作'''
    def setUp(self):
        User.objects.create(username='admin',email='admin@mail.com',password='admin123456')
...
class EventManageTest(TestCase):
    ...
    def setUp(self):
        ...
        Event.objects.create(name='xiaomi5',limit=2000,address='beijing',status=1,start_time='2018-10-18 12:00:00')
    ...
    def test_event_manage_sreach_success(self):
        '''测试发布会搜索'''
        # self.client.post('/login_action/', data=self.login_user)
        response = self.client.post('/event_search/', {'name':'xiaomi5'})
        self.assertEqual(response.status_code, 200)
        self.assertIn(b'xiaomi5', response.content)
        self.assertIn(b"beijing", response.content)
...
class GuestManageTest(TestCase):
    ...
    def setUp(self):
        User.objects.create_user('admin', 'admin@mail.com', 'admin123456')
        Event.objects.create(id=1,name='xiaomi5', limit=2000, address='beijing', status=1, start_time='2018-10-18 12:00:00')
...
class SignIndexActionTest(TestCase):
    ...
    def test_sign_index_action_sign_success(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(b'sign in sucess.', response.content)